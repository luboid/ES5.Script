...
namespace Test
{
    public class DateTest : ScriptTest
    {
...
");
        ...
        public void IncorrectConstructorArgumentsAreHandledProperly(string testName, string constructorCall)
        {
            ExecuteJS(@"
...
if (date_base*1 != date_actual*1) throw new Error(""" + testName + @": Date value is not correct: Actual: "" + date_actual + "" Expected: "" + date_base);
        ...
        public void DateMethodCall(string testName, string methodCall, string expectedValue)
        {
            ExecuteJS(
          @"
var date_base = new Date(2013, 1, 1);
